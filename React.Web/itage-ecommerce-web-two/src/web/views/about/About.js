				...
				<div className="custom-container">
					<Row>
						...
						<Col lg="6">
							...
							<p className="mb-2">
								{" "}
								Welcome to <b>ITage Shop</b> , your
							...
							<p className="mb-2">
								{" "}
								At <b>ITage Shop</b>, we are dedicated to
								providing our customers with the highest level
								of service and satisfaction. Our team works
								tirelessly to ensure that our website is
								up-to-date with the latest products, prices, and
								promotions. We also strive to make the shopping
								process as easy and convenient as possible for
								our customers.
							</p>
							<p>
								{" "}
								We are committed to delivering the highest
								quality products from the most reliable
								suppliers at competitive prices. We believe in
								transparency and honesty in all our{" "}
								<b>business dealings</b>, and we take pride in
								delivering products that meet our customers'
								expectations..
							</p>
						</Col>
					</Row>
