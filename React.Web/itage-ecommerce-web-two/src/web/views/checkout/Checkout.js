				...
				if (finalData != null) {
					setTimeout(() => {
						...
						if (
							...
							finalData.productsData.some(
								(el) => el.DiscountedPrice > 0
							)
						) {
																...
																<tr>
																	...
																	>
																		<span
																			...
																			className="order-total-check-lbl"
																		>
																			{t(
																				"order_total"
																			)}
