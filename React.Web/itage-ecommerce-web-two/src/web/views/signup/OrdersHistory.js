	...
	return (
		<>
			<Helmet>
				...
				<meta
					name="description"
					content={siteTitle + " Orders History"}
				/>
				<meta name="keywords" content="Orders History"></meta>
			</Helmet>

			<div className="bg-light">
				<SiteBreadcrumb title={t("order_history")} parent={t("home")} />
			...
			OrderItemsDetailList.length > 0 ? (
				<section
					id="order_item_detail"
					className="cart-section order-history section-big-py-space"
				>
					<div className="custom-container">
						<Row className="cart-buttons">
							<Col sm="12">
